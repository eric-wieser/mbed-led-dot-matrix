...
/***************************************************************************
*   Method     : BitArray - constructor
*   Description: This is the BitArray constructor.  It copies the
...
***************************************************************************/
bool BitArray::getBit(const unsigned int bit) const
{
	if (m_NumBits <= bit)
	{
		return false;         /* bit out of range */
	}
...
*                BitArray::Index which includes an = method used to
*                set bit values.
*   Parameters : bit - index of array bit
*   Effects    : None
*   Returned   : BitArray::Index (pointer to bit)
***************************************************************************/
BitArray::Index BitArray::operator[](const unsigned int bit)
{
	BitArray::Index result(this, bit);
...
/***************************************************************************
*   Method     : BitArray::Index - constructor
*   Description: This is the BitArray::Index constructor.  It stores a
...
*   Returned   : None
***************************************************************************/
BitArray::Index::Index(BitArray *array,
...
*   Returned   : None
***************************************************************************/
bool BitArray::Index::operator=(const bool src)
{
	if (m_BitArray != NULL)
	{
		if (src)
...
*   Returned   : None
***************************************************************************/
BitArray::Index BitArray::Index::operator=(const BitArray::Index src)
{
	*this = (bool) src;
	return src;
}
...
*   Description: overload of the bool() operator.  Gets the bit array bit to
*                the value of src.
*   Parameters : src - bit value
*   Returned   : Bit pointed to by this object
***************************************************************************/
BitArray::Index::operator bool() const
{
	if (m_BitArray == NULL)
	{
